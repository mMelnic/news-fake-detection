...
class NewsHelper {
  static final List<News> featuredNews =
      featuredNewsRawData.map((data) => News.fromMap(data)).toList();

  static final List<News> breakingNews =
      breakingNewsRawData.map((data) => News.fromMap(data)).toList();

  static final List<News> recomendationNews =
      recomendationNewsRawData.map((data) => News.fromMap(data)).toList();

  static final List<News> allCategoriesNews =
      allCategoriesNewsRawData.map((data) => News.fromMap(data)).toList();

  static final List<News> searchNews =
      searchNewsRawData.map((data) => News.fromMap(data)).toList();

  static final List<News> bookmarkedNews =
      bookmarkedNewsRawData.map((data) => News.fromMap(data)).toList();
}
